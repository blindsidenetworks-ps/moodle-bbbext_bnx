...
/**
 * JS room updater for bbbext_bnx.
 *
 * @module      bbbext_bnx/roomupdater
...
import {getMeetingInfo} from 'bbbext_bnx/repository';
...
export const updateRoom = (updatecache = false) => {
    ...
    const pendingPromise = new Pending('bbbext_bnx/roomupdater:updateRoom');
    ...
    return getMeetingInfo(bbbId, groupId, updatecache)
        .then(data => {
            ...
            return Templates.renderForPromise('bbbext_bnx/room_view', data);
        })
